...
# Configure SSL
sudo certbot --nginx --non-interactive --agree-tos --redirect -d gocongress.org -d www.gocongress.org -d gc2026.gocongress.org -m webmaster@gocongress.org
sudo certbot --nginx --non-interactive --agree-tos --redirect -d prizes.gocongress.org -m webmaster@gocongress.org
